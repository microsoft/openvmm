...
//!
//! A test binary declares its scenarios with [`opentmk_tests!`] and its
//! backends with [`opentmk_backends!`], then hands the generated `dispatch`
//! function to [`run_test`] together with the embedded config region.
...
/// `dispatch` is the function generated by [`opentmk_backends!`].
///
...
pub fn run_test(
    cfg: &OpenTmkConfig,
    dispatch: fn(&str, &str, &serde_json::Value) -> bool,
) {
