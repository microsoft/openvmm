RUST_BACKTRACE=1  CARGO_PROFILE_RELEASE_force_frame_pointers=yes cargo +stable build -p opentmk --target x86_64-unknown-uefi --release  #--target-dir ./target/x86_64-unknown-uefi/debug
