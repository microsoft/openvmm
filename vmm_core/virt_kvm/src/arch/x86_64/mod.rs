...
impl virt::Hypervisor for Kvm {
    ...
    fn supported_capabilities(&self) -> virt::SupportedCapabilities {
        // KVM on x86 can expose VMX/SVM to the guest. Whether the host
        // actually supports it is verified during partition creation.
        virt::SupportedCapabilities { nested_virt: true }
    }
