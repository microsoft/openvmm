...
mod tests {
    ...
    fn test_tdx_measurement() {
        let ref_mrtd: [u8; 48] = [
            177, 125, 101, 160, 26, 73, 66, 51, 43, 229, 171, 193, 205, 39, 114, 116, 32, 225, 168,
            137, 81, 181, 188, 1, 182, 78, 169, 201, 213, 33, 119, 125, 54, 185, 176, 195, 75, 60,
            213, 249, 223, 251, 110, 86, 150, 94, 243, 113,
        ];
