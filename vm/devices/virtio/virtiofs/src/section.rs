...
use ntapi::winnt::PAGE_READWRITE;
use ntapi::winnt::SEC_COMMIT;
use ntapi::winnt::SECTION_MAP_READ;
use ntapi::winnt::SECTION_MAP_WRITE;
use ntapi::winnt::SECTION_QUERY;
