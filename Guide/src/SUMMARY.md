...
- [Devices]()
  ...
  - [VNC](./reference/devices/vnc/architecture.md)
    - [Comparison with other VNC servers](./reference/devices/vnc/comparison-with-other-vnc-servers.md)
    - [Dirty-tracking tile size](./reference/devices/vnc/tile-size.md)
    - [Keyboard](./reference/devices/vnc/keyboard.md)
    - [Common client capabilities](./reference/devices/vnc/common-vnc-client-capabilities.md)
- [Device Backends]()
  - [Serial]()
  - [Graphics and Input]()
