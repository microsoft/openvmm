...
today equals VP index N; see
[VP identity](../vmbus/channels.md#vp-index-cpu-number-and-apic-id)).
...
3. **Subchannel count ≠ parallelism guarantee.** Even with many
   ...
   much work each channel can actually process. See the
   [subchannel scaling](../../devices/vmbus/storvsp_channels.md#subchannel-scaling)
   section.
