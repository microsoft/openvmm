...
pub struct UnderhillEnvCfg {
    ...
    /// Request and persist TVM host-certification evidence
        ...
        let ak_cert_type = {
            ...
            match attestation_type {
                ...
                AttestationType::Host => {
                    ...
                    if tvm_host_certification {
                        TpmAkCertTypeResource::HostCertified(request_ak_cert, handle_ak_cert)
                    } else {
                        TpmAkCertTypeResource::Trusted(request_ak_cert, handle_ak_cert)
                    }
                }
                AttestationType::Cca => {
                    anyhow::bail!(
