...
pub fn windows_amd_1es_hosted_largedisk() -> GhRunner {
...
/// jobs that require more than the default disk space (e.g. to ensure vmm_tests
/// have enough space to download test VHDs)
pub fn windows_intel_1es_hosted_largedisk() -> GhRunner {
    GhRunner::SelfHosted(vec![
        "self-hosted".to_string(),
...
pub fn windows_arm_1es_hosted() -> GhRunner {
    GhRunner::SelfHosted(vec![
        "self-hosted".to_string(),
...
pub fn linux_arm_1es_hosted() -> GhRunner {
    GhRunner::SelfHosted(vec![
        "self-hosted".to_string(),
        "1ES.Pool=OpenVMM-GitHub-ARM64-Pool-WestUS2".to_string(),
...
pub fn linux_1es_hosted_largedisk() -> GhRunner {
    GhRunner::SelfHosted(vec![
        "self-hosted".to_string(),
...
pub fn windows_amd_self_hosted_vm() -> GhRunner {
    GhRunner::SelfHosted(vec![
        "self-hosted".to_string(),
        "Windows".to_string(),
        "X64".to_string(),
...
pub fn windows_intel_self_hosted_vm() -> GhRunner {
    GhRunner::SelfHosted(vec![
        "self-hosted".to_string(),
        "Windows".to_string(),
        "X64".to_string(),
...
pub fn linux_amd_self_hosted_vm() -> GhRunner {
    GhRunner::SelfHosted(vec![
        "self-hosted".to_string(),
        "Linux".to_string(),
        "X64".to_string(),
...
pub fn linux_intel_self_hosted_vm() -> GhRunner {
    GhRunner::SelfHosted(vec![
        "self-hosted".to_string(),
        "Linux".to_string(),
        "X64".to_string(),
