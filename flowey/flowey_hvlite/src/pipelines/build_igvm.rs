...
pub enum OpenhclRecipeCli {
    ...
    X64CvmDevkern,
    /// X64 OpenHCL, with CVM support, plus Azure Local support.
    X64CvmAzureLocal,
...
impl IntoPipeline for BuildIgvmCli {
    fn into_pipeline(self, backend_hint: PipelineBackendHint) -> anyhow::Result<Pipeline> {
        ...
        let recipe_arch = match recipe {
            ...
            | OpenhclRecipeCli::X64CvmAzureLocal
        ...
        .dep_on(|ctx| flowey_lib_hvlite::_jobs::local_build_igvm::Params {
            ...
            base_recipe: match recipe {
                ...
                OpenhclRecipeCli::X64CvmAzureLocal => OpenhclIgvmRecipe::X64CvmAzureLocal,
