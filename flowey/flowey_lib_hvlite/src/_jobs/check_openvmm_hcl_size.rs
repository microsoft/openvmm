...
//! Verify that the msft-internal OpenHCL hasn't unexpectedly grown / shrank too
//! much in size.
...
impl SimpleFlowNode for Node {
    ...
    fn process_request(request: Self::Request, ctx: &mut NodeCtx<'_>) -> anyhow::Result<()> {
        ...
        let hvlite_repo_path = ctx.reqv(crate::git_checkout_openvmm_repo::req::GetRepoDir);
        ...
        let openhcl_vmm = ctx.reqv(|v| crate::build_openvmm_hcl::Request {
            build_params: crate::build_openvmm_hcl::OpenvmmHclBuildParams {
                ...
                features: [crate::build_openvmm_hcl::OpenvmmHclFeature::Tpm].into(),
        ...
        let did_verify_usermode_size =
            ctx.emit_rust_step("verify openhcl_vmm usermode bin size", |ctx| {
                ...
                let hvlite_repo_path = hvlite_repo_path.clone().claim(ctx);
                ...
                |rt| {
                    ...
                    sh.change_dir(rt.read(hvlite_repo_path));
                    xshell::cmd!(
                        sh,
                        "{xtask} verify-size
        ...
        let openhcl_kernel =
            ctx.reqv(
                |v| crate::download_openhcl_kernel_package::Request::GetPackage {
                    kind: crate::download_openhcl_kernel_package::OpenhclKernelPackageKind::Main,
                    arch: crate::download_openhcl_kernel_package::OpenhclKernelPackageArch::X86_64,
                    pkg: v,
                },
            );
        ...
        let did_verify_kernel_size = ctx.emit_rust_step("verify OpenHCL kernel size", |ctx| {
            ...
            let hvlite_repo_path = hvlite_repo_path.claim(ctx);
