...
pub mod resolve {
    ...
    impl SimpleFlowNode for Node {
        ...
        fn process_request(request: Self::Request, ctx: &mut NodeCtx<'_>) -> anyhow::Result<()> {
            ...
            let latest_release_igvm_files = ctx.reqv(
                |v| download_release_igvm_files_from_gh::resolve::Request {
            ...
            ctx.emit_rust_step("copy downloaded release igvm files to artifact dir", move |ctx| {
